...
public class ProgramStartupTests
{
    ...
    public void Settings_Should_Be_Configured()
    {
        ...
        settings.Value.ContainerName.Should().Be("food-test");
    }
    ...
    /// <summary>
    /// Validates Singleton lifetime for CosmosClient across multiple resolutions
    ...
    /// <summary>
    /// Validates Scoped lifetime for ICosmosRepository across scopes
    /// Per decision-record 2025-10-28-service-lifetime-registration.md:
    ...
    /// <summary>
    /// Validates Singleton lifetime for IOptions&lt;Settings&gt;
    /// Per decision-record 2025-10-28-service-lifetime-registration.md:
    ...
    /// <summary>
    /// Validates no duplicate service registrations exist
    /// Per decision-record 2025-10-28-service-lifetime-registration.md:
    ...
    public void Services_Should_Not_Have_Duplicate_Registrations()
    {
        ...
        options.Value.ContainerName.Should().Be("food-test", "Test config should be loaded");
    }
}
